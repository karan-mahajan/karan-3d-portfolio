  ...
  projects: [
    {
      name: "findabl",
      summary:
        "findabl is a full-stack SaaS platform I designed and built single-handedly to help businesses improve their visibility across AI-powered search tools like ChatGPT, Gemini, Perplexity, and Microsoft Copilot.",
      description:
    ...
    },
    {
      ...
      summary:
        "I built and maintained a large-scale, multi-brand enterprise web platform serving two major Ontario utilities — Alectra Utilities and Guelph Hydro — powering their public sites, customer portals, and a shared UI component library consumed by third-party billing and account-management apps.",
      description:
      ...
      links: {
        live: "https://alectrautilities.com/",
        github: null,
        caseStudy: null,
      },
    ...
    },
    {
      ...
      summary:
        "I built a native macOS writing assistant that lives in the system tray and drafts replies in my own voice across Teams, Outlook, JIRA, Confluence, GitHub, and ChatGPT.",
      description:
      ...
      links: {
        live: "",
        github:
          "https://github.com/karan-mahajan/Personal-AI-Writing-Assistant",
        caseStudy: null,
      },
      url: "",
      color: "#6366f1",
    ...
    },
    {
      name: "Interstone",
      summary:
        "I designed and built a custom WordPress theme for Interstone, a premium building-materials company, turning a 1500+product catalogue into a polished, fully responsive browsing experience with no transactional layer.",
      description:
    ...
    },
    {
      ...
      summary:
        "I led the Drupal 10 → 11 major-version migration for Alectra Inc.'s corporate website — one of Ontario's largest electricity distributors, serving over 1 million customers — upgrading the platform across a 60+ component, paragraph-based content system with no loss of content or layout.",
      description:
    ...
    },
    {
      name: "WEAL Website",
      summary:
        "Developed and designed a comprehensive website using Wix, enabling efficient sample submission and result management.",
      description:
    ...
    },
    {
      name: "Campus Cart",
      summary:
        "I built Campus Cart, a university marketplace web app on Django, Python, and PostgreSQL, restricted to verified staff and students so on-campus trading stays inside a trusted community.",
      description:
      ...
      links: {
        live: "",
        github: "https://github.com/karan-mahajan/CampusCart",
        caseStudy: null,
      },
      url: "",
      color: "#ff8c42",
    ...
    },
    {
      ...
      summary:
        "Developed a news article recommender system with Python (Pandas) and NLP, featuring a React JS UI and MongoDB storage.",
      description:
...
export function getProjectField(project, field, fallback = "") {
  ...
  if (field === "summary")
    return project.summary || project.description || fallback;
  if (field === "liveUrl")
    return project.links?.live || project.url || fallback;
