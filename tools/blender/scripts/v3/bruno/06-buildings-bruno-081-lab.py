"""Bruno's 081_lab.py - verbatim recreation.

`lab` zone scaffold — 3 MESH (refCarpet.001 with `labCarpet`, refWood, Cube.003)
+ 8 EMPTY (interactive point, physicalFixed, refFire, 2 CUBE wall colliders,
bounding/frustum CIRCLEs, root). Centre ~(13.14, -17.68).
...
Source: folio-2025/scripts/blender_world_steps/steps/081_lab.py
